...
class ofdm_txrx_only(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.msg_connect((self.epy_block_0, 'rx_cent_freq'), (self.ofdm_rx_hier_usrp_0, 'cent_freq'))
        self.msg_connect((self.epy_block_0, 'tx_cent_freq'), (self.ofdm_tx_hier_usrp_0, 'send_burst'))
        self.msg_connect((self.ofdm_rx_hier_usrp_0, 'packet_data'), (self.epy_block_0, 'packet_results'))
        ...
        self.connect((self.blocks_tag_gate_0, 0), (self.ofdm_rx_hier_usrp_0, 0))
        ...
        self.connect((self.ofdm_tx_hier_usrp_0, 1), (self.blocks_file_sink_0_0, 0))
