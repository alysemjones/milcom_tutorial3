...
from ofdm_rx_hier import ofdm_rx_hier  # grc-generated hier_block
from ofdm_tx_hier import ofdm_tx_hier  # grc-generated hier_block
import ofdm_txrx_sensing_epy_block_0 as epy_block_0  # embedded python block
import ofdm_txrx_sensing_epy_block_1 as epy_block_1  # embedded python block
import time
...
class ofdm_txrx_sensing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ofdm_txrx_sensing")
        ...
        self.block_size = block_size = int((front_pad+back_pad+80+800)*(wide_samp_rate/(1e6))/num_channels)
        ...
        self.pfb_channelizer_ccf_1_0 = pfb.channelizer_ccf(
            num_channels,
            firdes.low_pass_2(1.0,1,1/num_channels/2,(1/num_channels)*0.1,80,window.WIN_BLACKMAN_HARRIS),
            1,
            80)
        self.pfb_channelizer_ccf_1_0.set_channel_map(channel_map)
        self.pfb_channelizer_ccf_1_0.declare_sample_delay(0)
        self.ofdm_tx_hier_0 = ofdm_tx_hier(
            back_pad=back_pad,
            cent_freq=cent_freq,
            front_pad=front_pad,
        ...
        self.ofdm_rx_hier_0 = ofdm_rx_hier(
            cent_freq=-cent_freq,
            signal_samp_rate=signal_samp_rate,
            wide_samp_rate=wide_samp_rate,
        )
        self.epy_block_1 = epy_block_1.blk(num_chans=num_channels)
        self.epy_block_0 = epy_block_0.blk(num_channels=num_channels, wide_samp_rate=wide_samp_rate)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, wide_samp_rate,True)
        ...
        self.blocks_head_0 = blocks.head(gr.sizeof_gr_complex*1, head_size)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.epy_block_0, 'rx_cent_freq'), (self.ofdm_rx_hier_0, 'cent_freq'))
        self.msg_connect((self.epy_block_0, 'tx_cent_freq'), (self.ofdm_tx_hier_0, 'cent_freq'))
        self.msg_connect((self.epy_block_1, 'energy_vec'), (self.blocks_message_debug_0, 'print'))
        self.connect((self.analog_noise_source_x_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_tag_gate_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.pfb_channelizer_ccf_1_0, 0))
        ...
        self.connect((self.blocks_tag_gate_0, 0), (self.ofdm_rx_hier_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.ofdm_rx_hier_0, 0), (self.blocks_null_sink_0, 0))
        self.connect((self.ofdm_tx_hier_0, 0), (self.blocks_head_0, 0))
        self.connect((self.ofdm_tx_hier_0, 1), (self.blocks_null_sink_0_0, 0))
        self.connect((self.ofdm_tx_hier_0, 0), (self.epy_block_0, 0))
        self.connect((self.pfb_channelizer_ccf_1_0, 0), (self.blocks_streams_to_vector_0, 0))
        self.connect((self.pfb_channelizer_ccf_1_0, 1), (self.blocks_streams_to_vector_0, 1))
        self.connect((self.pfb_channelizer_ccf_1_0, 2), (self.blocks_streams_to_vector_0, 2))
        self.connect((self.pfb_channelizer_ccf_1_0, 3), (self.blocks_streams_to_vector_0, 3))
        self.connect((self.pfb_channelizer_ccf_1_0, 4), (self.blocks_streams_to_vector_0, 4))
        self.connect((self.pfb_channelizer_ccf_1_0, 5), (self.blocks_streams_to_vector_0, 5))
        self.connect((self.pfb_channelizer_ccf_1_0, 6), (self.blocks_streams_to_vector_0, 6))
        self.connect((self.pfb_channelizer_ccf_1_0, 7), (self.blocks_streams_to_vector_0, 7))
    ...
    def set_wide_samp_rate(self, wide_samp_rate):
        ...
        self.set_block_size(int((self.front_pad+self.back_pad+80+800)*(self.wide_samp_rate/(1e6))/self.num_channels))
        ...
        self.blocks_throttle_0.set_sample_rate(self.wide_samp_rate)
        self.epy_block_0.wide_samp_rate = self.wide_samp_rate
        self.ofdm_rx_hier_0.set_wide_samp_rate(self.wide_samp_rate)
        self.ofdm_tx_hier_0.set_wide_samp_rate(self.wide_samp_rate)
    ...
    def set_front_pad(self, front_pad):
        ...
        self.set_block_size(int((self.front_pad+self.back_pad+80+800)*(self.wide_samp_rate/(1e6))/self.num_channels))
        self.set_head_size(int((self.front_pad+self.back_pad+self.num_samps)*(self.wide_samp_rate/(1e6))*self.time_steps))
        self.ofdm_tx_hier_0.set_front_pad(self.front_pad)
    ...
    def set_back_pad(self, back_pad):
        ...
        self.set_block_size(int((self.front_pad+self.back_pad+80+800)*(self.wide_samp_rate/(1e6))/self.num_channels))
        self.set_head_size(int((self.front_pad+self.back_pad+self.num_samps)*(self.wide_samp_rate/(1e6))*self.time_steps))
        self.ofdm_tx_hier_0.set_back_pad(self.back_pad)
    ...
    def set_signal_samp_rate(self, signal_samp_rate):
        ...
        self.set_samps_per_symb(float(self.wide_samp_rate/self.signal_samp_rate))
        self.ofdm_rx_hier_0.set_signal_samp_rate(self.signal_samp_rate)
        self.ofdm_tx_hier_0.set_signal_samp_rate(self.signal_samp_rate)
    ...
    def set_num_channels(self, num_channels):
        ...
        self.epy_block_0.num_channels = self.num_channels
        self.epy_block_1.num_chans = self.num_channels
        self.pfb_channelizer_ccf_1_0.set_taps(firdes.low_pass_2(1.0,1,1/self.num_channels/2,(1/self.num_channels)*0.1,80,window.WIN_BLACKMAN_HARRIS))
    ...
    def set_head_size(self, head_size):
        ...
        self.set_num_samps_per_step(self.head_size/self.time_steps)
        self.blocks_head_0.set_length(self.head_size)
    ...
    def set_channel_map(self, channel_map):
        ...
        self.pfb_channelizer_ccf_1_0.set_channel_map(self.channel_map)
    ...
    def set_cent_freq(self, cent_freq):
        ...
        self.ofdm_rx_hier_0.set_cent_freq(-self.cent_freq)
        self.ofdm_tx_hier_0.set_cent_freq(self.cent_freq)
...
def main(top_block_cls=ofdm_txrx_sensing, options=None):
